    ...
    if (calGet3Di(ca, Q.imove[slot],cell_x,cell_y,cell_z) == PARTICLE_PRESENT)
      {
        ...
        r0[0] = rf[0] = calGet3Dr(ca, Q.rx[slot],cell_x,cell_y,cell_z);
        r0[1] = rf[1] = calGet3Dr(ca, Q.ry[slot],cell_x,cell_y,cell_z);
        r0[2] = rf[2] = calGet3Dr(ca, Q.rz[slot],cell_x,cell_y,cell_z);
        ...
        calSet3Dr(ca, Q.rx[slot],cell_x,cell_y,cell_z,rf[0]);
        calSet3Dr(ca, Q.ry[slot],cell_x,cell_y,cell_z,rf[1]);
        calSet3Dr(ca, Q.rz[slot],cell_x,cell_y,cell_z,rf[2]);
