    ...
    if (calGetBuffer3DElement(INT_SUBSTATE(ID_current, slot, PID),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z) > NULL_ID)
      {
        ...
        F0[0] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,FX),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        F0[1] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,FY),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        F0[2] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,FZ),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        ...
        p0[0] = pf[0] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,PX),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        p0[1] = pf[1] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,PY),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        p0[2] = pf[2] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,PZ),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        ...
        v0[0] = vf[0] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,VX),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        v0[1] = vf[1] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,VY),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        v0[2] = vf[2] = calGetBuffer3DElement(REAL_SUBSTATE(Q_current,slot,VZ),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z);
        ...
        calSetBuffer3DElement(REAL_SUBSTATE(Q_next,slot,PX),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z,pf[0]);
        calSetBuffer3DElement(REAL_SUBSTATE(Q_next,slot,PY),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z,pf[1]);
        calSetBuffer3DElement(REAL_SUBSTATE(Q_next,slot,PZ),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z,pf[2]);
        ...
        calSetBuffer3DElement(REAL_SUBSTATE(Q_next,slot,VX),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z,vf[0]);
        calSetBuffer3DElement(REAL_SUBSTATE(Q_next,slot,VY),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z,vf[1]);
        calSetBuffer3DElement(REAL_SUBSTATE(Q_next,slot,VZ),X_CELLS,Y_CELLS,cell_x,cell_y,cell_z,vf[2]);
      }
}
